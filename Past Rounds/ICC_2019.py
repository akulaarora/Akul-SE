...
def main(argv):
        ...
        # FORBIDDEN PROGRAMS
        # 4k Video Downloader
        if not applications.file_exists("/Program Files/4KDownload/4kvideodownloader/4kvideodownloader.exe"):
                html += "<p> - Removed forbidden 4k video downloader program</p>"
                points += 1
        total += 1
                
        # Epic Games Launcher (Fortnite Game)
        if not applications.file_exists("/Program Files (x86)/Epic Games/Launcher/Portal/Binaries/Win32/EpicGamesLauncher.exe"):
                html += "<p> - Removed forbidden Epic Games Launcher program</p>"
                points += 1
        total += 1
